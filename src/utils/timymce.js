...
! function () {
                ...
                for (S["@"] && (h = S["@"].attributes, v = S["@"].attributesOrder), t = 0, n = x.length; t < n; t++)
                    if (i = y.exec(x[t])) {
                        if (g = i[1], c = i[2], p = i[3], s = i[5], a = {
                            ...
                            for (r = 0, o = (s = fo(s, "|")).length; r < o; r++)(i = C.exec(s[r])) && (u = {}, f = i[1], l = i[2].replace(/[\\:]:/g, ":"), g = i[3], b = i[4], "!" === f && (a.attributesRequired = a.attributesRequired || [], a.attributesRequired.push(l), u.required = !0), "-" !== f ? (g && ("=" === g && (a.attributesDefault = a.attributesDefault || [], a.attributesDefault.push({
                                name: l,
                                value: b
    ...
    var xo = Vr(["h1", "h2", "h3", "h4", "h5", "h6"]),
        ...
        bi = (yi.prototype.bind = function (e, t, n, r) {
            ...
            if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
                ...
                for (var m = t.split(" "), g = m.length; g--;) c = o, s = l = !1, "DOMContentLoaded" === (u = m[g]) && (u = "ready"), f.domLoaded && "ready" === u && "complete" === e.readyState ? n.call(r, wo({
                    type: u
    ...
    function Ol(t, e, n, r) {
        ...
        if ((i = xl(s) && !s.wrapper ? a.getParent(n, s.block, u) : i) || (o = a.getParent(n, "LI,TD,TH"), i = a.getParent(qn(n) ? n.parentNode : n, function (e) {
                return e !== u && xf(t, e)
            }, o)), !(i = i && xl(s) && s.wrapper && Cf(a, i, "ul,ol").reverse()[0] || i))
    ...
    function ad(e, t, n, r) {
        od(e, t, e.dom.defaultView.innerHeight, n, r);
        var o, i, a, u, s, c, l, f = (o = n.element, u = Gt(Et.fromDom(document)), a = (i = Ud).owner(o), s = Fd(i, a), c = jn(o), l = B(s, function (e, t) {
                var n = jn(t);
                return {
                    left: e.left + n.left,
                    top: e.top + n.top
                    ...
                    if (!U || (s = K.getElementRule(i))) {
                        if (c = !0, U && (h = s.attributes, v = s.attributePatterns), (f = t[9]) ? ((p = -1 !== f.indexOf("data-mce-type")) && z && (c = !1), (g = []).map = {}, f.replace(L, function (e, t, n, r, o) {
                            ...
                            if (d = s.attributesRequired, b = s.attributesDefault, y = s.attributesForced, s.removeEmptyAttrs && !g.length && (c = !1), y)
                                for (r = y.length; r--;) a = (l = y[r]).name, "{$uid}" === (C = l.value) && (C = "mce_" + E++), g.map[a] = C, g.push({
                                    name: a,
                                    value: C
                                });
                            if (b)
                                for (r = b.length; r--;)(a = (l = b[r]).name) in g.map || ("{$uid}" === (C = l.value) && (C = "mce_" + E++), g.map[a] = C, g.push({
                                    name: a,
                                    value: C
                                }));
                            if (d) {
                                for (r = d.length; r-- && !(d[r] in g.map);); - 1 === r && (c = !1)
                            }
    ...
    function dg(e, t) {
        ...
        return h = t, v = b, y.exists(function (e) {
            ...
            if (0 < n.length) {
                ...
                var r = fg(a, i);
                return he.some(gp.partialTable(n, he.some(ke(ke({}, i), {
                    rng: r
                }))))
            }
            return he.none()
    ...
    function Tg(e, t, n) {
        ...
        if (m.isDefaultPrevented()) e.fire("SetContent", {
            ...
            var b, y, C, w, x, S, E, N, k, _, A, T, R, D, O = {
        ...
        if ("all" !== r.remove) {
            Rh(r.styles, function (e, t) {
                ...
                if (e = pl(e, o), E(t) && (t = e, i = null), r.remove_similar || !i || Dh(u.getAttrib(i, t), e))
                    if ("class" === t && (e = u.getAttrib(b, t)) && (n = "", X(e.split(/\s+/), function (e) {
                            /mce\-\w+/.test(e) && (n += (n ? " " : "") + e)
                        }), n)) u.setAttrib(b, t, n);
                    else {
    ...
    function jp(u, s, c, e, l) {
        ...
        if ("false" !== h.getContentEditable(r.getNode())) r.isCollapsed() && El(g) && !Ul(u).length ? Xg(u, s, c, l) : ($l(r, !0, function () {
            ql(u, t)
        }), El(g) && Ug(u, s, c, r.getStart()) && fl(h, r, r.getRng()), u.nodeChanged()), Df(u, s, e, c);
        else {
            e = r.getNode();
    ...
    function vh(c) {
        return {
            ...
            selection: {
                getContent: function (e, t) {
                    return function (e, t, n) {
                        var r, o = (r = t, ke(ke({}, n = void 0 === n ? {} : n), {
                                format: r,
                                get: !0,
                                selection: !0
                            })),
    ...
    function Qh(L, I) {
        ...
        return (t = U).addAttributeFilter("data-mce-tabindex", function (e, t) {
            ...
            serialize: function (e, t) {
                var n, r, o, i, a, u, s, c, l, f, d, m, g, p, h, v, b, y, C, w, x, S, E, N, k, _, A, T, R, D = ke({
                        format: "html"
                    }, t = void 0 === t ? {} : t),
                ...
                return "tree" === D.format ? B : (N = I, k = D, _ = B, R = sm(L, F).serialize(_), k.no_events || !N ? R : (A = N, T = ke(ke({}, k), {
                    content: R
    ...
    function b1(t, e) {
        ...
        h.disabled = !0, t.readonly = !!n.readonly, t.readonly || (t.inline && "static" === I1.getStyle(h, "position", !0) && (h.style.position = "relative"), h.contentEditable = t.getParam("content_editable_state", !0)), h.disabled = !1, t.editorUpload = Xv(t), t.schema = go(n), t.dom = cu(o, {
            ...
            p.cancel(), "touchcancel" !== t.type && m.get().filter(function (e) {
                ...
                g.get() ? t.preventDefault() : d.fire("tap", ke(ke({}, t), {
                    type: "tap"
                }))
            })
...
tinymce.baseURL = "https://cdn.tiny.cloud/1/invalid-origin/tinymce/5.9.2-117"
